...
def list_my_companies(
    ...
    data = membership_service.list_user_companies(db, current_user)
...
def get_my_context(
    ...
    data = membership_service.get_user_context(db, current_user, company_id)
...
def get_my_stats(
    ...
    data = submission_service.get_company_stats(db, membership)
    return success_response(data.model_dump(mode="json"))
