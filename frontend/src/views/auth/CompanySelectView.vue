...
const activeCompanyId = computed(() => contextStore.context?.active_company?.id ?? contextStore.selectedCompanyId)
...
<template>
  <div style="min-height:100dvh;background:var(--sa-bg);display:flex;flex-direction:column;">
    ...
    <!-- Header escuro -->
    <div style="background:var(--sa-nav);padding:18px 24px;display:flex;align-items:center;justify-content:space-between;">
      <div style="display:flex;align-items:center;gap:10px;">
        <div style="width:30px;height:30px;background:var(--sa-brand);border-radius:7px;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:13px;color:#fff;">SA</div>
        <div style="font-size:14px;font-weight:700;color:#fff;">Smart Audit</div>
      </div>
      <RouterLink
        to="/login"
        style="font-size:12px;font-weight:600;color:rgba(255,255,255,.4);text-decoration:none;"
    ...
    <div style="flex:1;display:flex;align-items:flex-start;justify-content:center;padding:40px 16px;">
      <div style="width:100%;max-width:560px;">
        ...
        <div style="margin-bottom:28px;">
          <div class="eyebrow" style="margin-bottom:4px;">Acesso multi-empresa</div>
          <h1 style="font-size:clamp(1.4rem,3vw,2rem);font-weight:700;letter-spacing:-.02em;color:var(--sa-text);margin-bottom:6px;">
            Selecione a empresa
          </h1>
        ...
        <div style="display:flex;flex-direction:column;gap:10px;">
          ...
          >
            <div style="display:flex;align-items:flex-start;gap:14px;">
              <!-- Ícone -->
              <div style="width:42px;height:42px;border-radius:10px;flex-shrink:0;background:var(--sa-brand-soft);display:flex;align-items:center;justify-content:center;color:var(--sa-brand);font-weight:800;font-size:16px;">
                SA
              </div>
              ...
              <div style="flex:1;min-width:0;">
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px;">
                  ...
                  <span style="font-size:10px;font-weight:600;color:var(--sa-muted);background:var(--sa-bg);padding:2px 7px;border-radius:4px;text-transform:uppercase;letter-spacing:.06em;">
                    {{ company.plan }}
                  </span>
                </div>
                <!-- Contadores — mostrar stats se for a empresa ativa, senão mostrar traço -->
              ...
              <!-- Badge + Chevron/loading empilhados -->
